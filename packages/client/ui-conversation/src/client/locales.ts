...
export const zh = {
  ...
  'annotation.placeholder': '添加可选评论…',
  'annotation.confirm': '添加到输入框',
  'annotation.comment': '批注',
...
export const en = {
  ...
  'annotation.addToConversation': 'Add to conversation',
  'annotation.placeholder': 'Add an optional comment…',
  'annotation.confirm': 'Add to composer',
